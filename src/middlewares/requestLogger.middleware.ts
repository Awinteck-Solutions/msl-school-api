...
const getPurpose = (method: string, endpoint: string): string | undefined => {
  ...
  const rules: Array<{ method: string; pattern: RegExp; purpose: string }> = [
    ...
    // Subscription
    { method: "GET", pattern: toRegex("/subscription/plan"), purpose: "VIEW-SUBSCRIPTION-PLAN" },
    { method: "GET", pattern: toRegex("/subscription/status"), purpose: "VIEW-SUBSCRIPTION-STATUS" },
    { method: "POST", pattern: toRegex("/subscription/subscribe"), purpose: "SUBSCRIBE" },
    { method: "GET", pattern: toRegex("/subscription/invoices"), purpose: "VIEW-SUBSCRIPTION-INVOICES" },
    { method: "POST", pattern: toRegex("/subscription/invoices/:id/pay"), purpose: "PAY-SUBSCRIPTION-INVOICE" },
    { method: "GET", pattern: toRegex("/subscription/verify/:reference"), purpose: "VERIFY-SUBSCRIPTION-PAYMENT" },
    { method: "GET", pattern: toRegex("/subscription/callback"), purpose: "VIEW-SUBSCRIPTION-CALLBACK" },
    { method: "POST", pattern: toRegex("/subscription/webhook"), purpose: "SUBSCRIPTION-WEBHOOK" },
    { method: "POST", pattern: toRegex("/subscription/cancel"), purpose: "CANCEL-SUBSCRIPTION" },
    { method: "GET", pattern: toRegex("/admin/subscription/plan"), purpose: "VIEW-ADMIN-SUBSCRIPTION-PLAN" },
    { method: "PUT", pattern: toRegex("/admin/subscription/plan"), purpose: "UPDATE-ADMIN-SUBSCRIPTION-PLAN" },
    { method: "GET", pattern: toRegex("/admin/subscription"), purpose: "VIEW-ADMIN-SUBSCRIPTIONS" },
    { method: "GET", pattern: toRegex("/admin/subscription/invoices"), purpose: "VIEW-ADMIN-SUBSCRIPTION-INVOICES" },
    { method: "POST", pattern: toRegex("/admin/subscription/resources"), purpose: "CREATE-SUBSCRIPTION-RESOURCE" },
    { method: "PATCH", pattern: toRegex("/admin/subscription/resources"), purpose: "UPDATE-SUBSCRIPTION-RESOURCE" },
    { method: "PATCH", pattern: toRegex("/admin/subscription/resources/thumbnail"), purpose: "UPDATE-SUBSCRIPTION-RESOURCE-THUMBNAIL" },
    { method: "GET", pattern: toRegex("/admin/subscription/resources"), purpose: "VIEW-SUBSCRIPTION-RESOURCES" },
    { method: "GET", pattern: toRegex("/admin/subscription/resources/:id"), purpose: "VIEW-SUBSCRIPTION-RESOURCE" },
    { method: "DELETE", pattern: toRegex("/admin/subscription/resources/:id"), purpose: "DELETE-SUBSCRIPTION-RESOURCE" },
    { method: "POST", pattern: toRegex("/admin/subscription/resources/:id/files"), purpose: "UPLOAD-SUBSCRIPTION-RESOURCE-FILES" },
    { method: "POST", pattern: toRegex("/admin/subscription/resources/:id/process-from-url"), purpose: "PROCESS-SUBSCRIPTION-RESOURCE-URL" },
    { method: "POST", pattern: toRegex("/admin/subscription/resources/:id/process"), purpose: "PROCESS-SUBSCRIPTION-RESOURCE-FILES" },
    { method: "POST", pattern: toRegex("/admin/subscription/resources/process"), purpose: "PROCESS-SUBSCRIPTION-RESOURCES" },
    { method: "GET", pattern: toRegex("/subscription/resources"), purpose: "VIEW-USER-SUBSCRIPTION-RESOURCES" },
    { method: "GET", pattern: toRegex("/admin/subscription/resources/processing-status"), purpose: "VIEW-SUBSCRIPTION-PROCESSING-STATUS" },
    { method: "GET", pattern: toRegex("/admin/subscription/ai/collection-info"), purpose: "VIEW-SUBSCRIPTION-AI-COLLECTION" },
    { method: "GET", pattern: toRegex("/admin/subscription/ai/limits"), purpose: "VIEW-SUBSCRIPTION-AI-LIMITS" },
    { method: "PUT", pattern: toRegex("/admin/subscription/ai/limits"), purpose: "UPDATE-SUBSCRIPTION-AI-LIMITS" },
    { method: "GET", pattern: toRegex("/admin/subscription/ai/usage"), purpose: "VIEW-SUBSCRIPTION-AI-USAGE" },
    { method: "GET", pattern: toRegex("/admin/subscription/ai/usage/:studentId"), purpose: "VIEW-SUBSCRIPTION-AI-STUDENT-USAGE" },
    { method: "POST", pattern: toRegex("/subscription-ai/query-general-stream"), purpose: "QUERY-SUBSCRIPTION-AI-STREAM" },
    { method: "POST", pattern: toRegex("/subscription-ai/query-general"), purpose: "QUERY-SUBSCRIPTION-AI" },
    { method: "POST", pattern: toRegex("/subscription-ai/query-general-context"), purpose: "QUERY-SUBSCRIPTION-AI-CONTEXT" },
    { method: "POST", pattern: toRegex("/subscription-ai/query-general-context-stream"), purpose: "QUERY-SUBSCRIPTION-AI-CONTEXT-STREAM" },
    { method: "POST", pattern: toRegex("/subscription-ai/query-general-context-audio-text-stream"), purpose: "QUERY-SUBSCRIPTION-AI-AUDIO-TEXT-STREAM" },
    { method: "POST", pattern: toRegex("/subscription-ai/query-image"), purpose: "QUERY-SUBSCRIPTION-AI-IMAGE" },
    { method: "POST", pattern: toRegex("/subscription-ai/voice-to-text"), purpose: "SUBSCRIPTION-AI-VOICE-TO-TEXT" },
    { method: "GET", pattern: toRegex("/subscription-ai/history"), purpose: "VIEW-SUBSCRIPTION-AI-HISTORY" },
    { method: "GET", pattern: toRegex("/subscription-ai/recent-activity"), purpose: "VIEW-SUBSCRIPTION-AI-ACTIVITY" },
    { method: "POST", pattern: toRegex("/subscription-ai/summarize"), purpose: "SUMMARIZE-SUBSCRIPTION-AI" },
